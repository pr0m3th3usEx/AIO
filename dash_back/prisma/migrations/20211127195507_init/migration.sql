-- CreateEnum
CREATE TYPE "ServiceType" AS ENUM ('GOOGLE', 'WEATHER', 'CRYPTO', 'INTRANET', 'TWITTER', 'REDDIT');

-- CreateEnum
CREATE TYPE "WidgetType" AS ENUM ('TRANSLATOR', 'CITY_TEMPERATURE', 'CRYPTO', 'INTRA_INFO', 'USER_TWEETS', 'SUBREDDIT');
